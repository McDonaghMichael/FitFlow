...
export class EnterManuallyPage implements OnInit {
  ...
  foodArray = [
    { id: "aaa", name: 'Apple', brand: 'Tesco', calories: 95 },
    { id: "aba", name: 'Banana', brand: 'Lidl', calories: 105 },
    { id: "aaea", name: 'Orange Juice', brand: 'Aldi', calories: 120 },
    { id: "aa43a", name: 'Granola Bar', brand: 'Dunnes', calories: 200 },
    { id: "agaa", name: 'Apple Pie', brand: 'Lidl', calories: 250 },
  ];
